...
<body>
    ...
    <nav class="navbar navbar-default" role="navigation">
       ...
       <div class="navbar-header navbar-right"  >
        ...
        <?php
          if($_SESSION['user']['USERS_ROLE']=='Visitor'){
        ?>  
       <div class="navbar-header  navbar-right"">
            <div class="navbar-form navbar-left">
                <button class="btn btn-info" data-toggle="modal" data-target="#up">升级帐号</button>
            </div>
        </div>
        <?php } ?>
        ...
        <?php
          if($_SESSION['user']['USERS_ROLE']=='VIP'){
        ?>  
       <div class="navbar-header  navbar-right"">
        ...
        <?php
         ...
         <div class="navbar-header  navbar-right"">
            <form action="/index.php?r=Visitor/cloud_store" method="POST" class="navbar-form navbar-left">
                <button type="submit" class="btn btn-info">云空间</button>
            </form>
        </div>
      <?php }?>
        ...
        <form action="index.php?r=Visitor/arouse" method="POST">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="row">
                            <div class="col-md-offset-1 col-md-10 pt25">
                                <div class="form-group">
                                    <p class="help-block text-danger">激活码请联系管理员进行购买</p>
                                </div>
                            </div>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="row">
                            <div class="col-md-offset-1 col-md-10 pt25">
                                <div class="form-group">
                                    <div class="inp-icon user">
                                        <input type="text" class="form-control inp" placeholder="输入激活码" id="uname" name="aaid" required="">
                                    </div>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                        ...
                        <div align="center">
                            <button type="submit" class="button small"  >激活</button>
                        </div>
                    </div><!-- /.modal-content -->
                </div><!-- /.modal -->
            </div>
